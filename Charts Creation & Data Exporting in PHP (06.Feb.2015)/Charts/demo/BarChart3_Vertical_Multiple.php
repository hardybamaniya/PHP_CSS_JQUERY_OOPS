<?php
	...
	$chart->setTitle("Average family income (k$) using Multiple Vertical bar chart ");
	$chart->render("generated/demo6.png");
?>
<html>
<head>
	<title>Multiple Vertical bar chart demonstration</title>
</head>
<body>
	<img alt="Multiple Vertical bar chart" src="generated/demo6.png" style="border: 1px solid gray;"/>
</body>
</html>